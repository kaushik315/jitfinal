...
const dataabout = {
    ...
    aboutme: "We are a team of highly qualified, committed, and professional chartered accountants with over 30 years of cumulative experience.  We offer a wide range of accounting, tax, and business advising services to help our clients navigate the complex financial landscape of today's corporate environment. Our main goal is to deliver timely and exceptional high-quality service in order to meet the demands of our Stakeholders. We take great pleasure in establishing and maintaining dependable connections with our clients that allow them to succeed and increase the value of their businesses through timely and personalised advise. Our clientele spans the whole of England which are Small and Medium Scale Enterprises. We are dedicated to offering top-notch service that is customised to meet each client's unique demands. You can be certain that JiT Accountants will provide you with wise counsel that will protect the sustainability of your business.",
};
const worktimeline = [{
